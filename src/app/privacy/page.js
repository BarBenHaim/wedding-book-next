...
export default function PrivacyPage() {
    return (
        <div dir='rtl' className='legal'>
            ...
            <h2>זכויותיכם</h2>
            <p>ניתן לבקש עיון, תיקון או מחיקה של מידע בכל עת. מחיקת חשבון זמינה ישירות מתוך האפליקציה (מסך הבית ← חשבון ופרטיות ← מחיקת חשבון), וגם בעמוד <a href='/account-deletion'>מחיקת חשבון ומידע</a> — בלי צורך להתקין את האפליקציה. לאחר מחיקת החשבון יוסרו גם האירועים והתכנים המשויכים אליו.</p>
