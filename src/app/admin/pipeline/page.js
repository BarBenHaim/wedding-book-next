    ...
    return (
        <div className='bg-white rounded-xl border border-[#e7dcc6] p-3' style={passedButEarly ? { borderColor: '#f0b8b8', boxShadow: '0 0 0 1px #f0b8b8' } : undefined}>
            ...
            <div className='flex gap-2 mt-2 flex-wrap'>
                <a href={`/admin/wedding/${w.id}/picabook-export`} className='flex items-center gap-1 text-[10.5px] font-bold text-white bg-[#4a6cf7] px-2 py-1 rounded-lg'>
                    <Printer size={11} /> Picabook
                </a>
                {w.slug && (
