            ...
            <div className='relative z-10 flex flex-1 flex-col items-center text-center px-4 sm:px-6'>
                ...
                <section className='max-w-3xl pt-12 sm:pt-16 md:pt-20 pb-12 sm:pb-16'>
                    ...
                    <p className='text-base sm:text-lg md:text-xl text-[#5a5040] max-w-xl mb-8 mx-auto leading-relaxed animate-slideUp' style={{ animationDelay: '0.1s' }}>
                        האורחים מעלים ברכות ותמונות, ואנחנו מעצבים הכול לספר חתונה מודפס שנשאר לנצח.
                    </p>
                ...
                <section className='w-full max-w-4xl mb-12 sm:mb-20'>
                    <h2 className='text-2xl sm:text-3xl font-[800] text-[#18140F] mb-2'>איך זה עובד?</h2>
                    <p className='text-[#5a5040] mb-8 text-sm sm:text-base'>שלושה שלבים פשוטים ליצירת הספר המושלם</p>
                        ...
                        {[
                            {
                                step: '01',
                                title: 'שיתוף קישור',
                                desc: 'שלחו לאורחים קישור או QR — בוואטסאפ, בהזמנה, על שלט.',
                                icon: <svg className='w-8 h-8' fill='none' stroke='#AA8840' strokeWidth={1.5} viewBox='0 0 24 24'><path strokeLinecap='round' strokeLinejoin='round' d='M7.217 10.907a2.25 2.25 0 1 0 0 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186 9.566-5.314m-9.566 7.5 9.566 5.314m0 0a2.25 2.25 0 1 0 3.935 2.186 2.25 2.25 0 0 0-3.935-2.186Zm0-12.814a2.25 2.25 0 1 0 3.933-2.185 2.25 2.25 0 0 0-3.933 2.185Z' /></svg>,
                            },
                            {
                                step: '02',
                                title: 'קבלת ברכות ותמונות',
                                desc: 'האורחים מצלמים ומברכים ישירות מהנייד — בלי אפליקציה.',
                                icon: <svg className='w-8 h-8' fill='none' stroke='#AA8840' strokeWidth={1.5} viewBox='0 0 24 24'><path strokeLinecap='round' strokeLinejoin='round' d='M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z' /></svg>,
                            },
                            {
                                step: '03',
                                title: 'ספר מודפס ביוקרה',
                                desc: 'מעצבים את הספר בממשק נוח ומקבלים ספר מודפס הביתה.',
                                icon: <svg className='w-8 h-8' fill='none' stroke='#AA8840' strokeWidth={1.5} viewBox='0 0 24 24'><path strokeLinecap='round' strokeLinejoin='round' d='M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25' /></svg>,
                            },
                        ].map((item, i) => (
                            <div key={i} className='relative z-10 rounded-2xl bg-white/80 backdrop-blur-sm p-6 sm:p-8 text-center border border-[rgba(170,136,64,0.08)] card-hover group'>
                                {/* Step number badge */}
                                <div className='absolute -top-3 right-4 bg-gradient-to-r from-[#AA8840] to-[#c9a44e] text-white text-xs font-bold px-3 py-1 rounded-full shadow-md'>
                                    {item.step}
                                </div>
                                {/* Icon with ring */}
                ...
                <section className='w-full max-w-4xl mb-12 sm:mb-20'>
                    <div className='rounded-2xl bg-white/50 backdrop-blur-sm p-6 sm:p-8 border border-[rgba(170,136,64,0.08)]'>
                        <h2 className='text-2xl font-[800] text-[#18140F] mb-6 text-center'>אנחנו מהימנים לזוגות</h2>
                        <div className='grid grid-cols-1 sm:grid-cols-3 gap-8'>
                            {[
                                { stat: '2,500+', label: 'חתונות', desc: 'ספרים יפים שנוצרו' },
                                { stat: '98%', label: 'שביעות רצון', desc: 'מהזוגות הממליצים' },
                                { stat: '500k+', label: 'ברכות', desc: 'מאורחים שמעו ושמרו' },
                            ].map((item, i) => (
                ...
                <section className='w-full max-w-2xl pb-16 sm:pb-20'>
                    <div className='rounded-3xl bg-[#18140F] p-6 sm:p-10 text-center shadow-2xl relative overflow-hidden'>
                        ...
                        <p className='text-[#d4b867]/80 mb-6 text-sm sm:text-base'>התחילו בחינם ותנו לאורחים ליצור איתכם זכרון לנצח.</p>
                        <button
                            onClick={() => router.push('/register')}
