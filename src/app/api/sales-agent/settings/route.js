...
export async function PUT(req) {
    ...
    try {
        ...
        const known = [
            ...
            'INVALID_MODEL_EXPERIMENT_ID', 'INVALID_MODEL_EXPERIMENT_REVISION',
            'INVALID_MODEL_EXPERIMENT_ARMS', 'INVALID_MODEL_EXPERIMENT_WEIGHT',
            'INVALID_MODEL_ARM_ID', 'INVALID_MODEL_ARM_PROVIDER', 'INVALID_MODEL_ARM_MODEL',
            'INVALID_MODEL_ARM_WEIGHT', 'INVALID_MODEL_ARM_REVISION', 'DUPLICATE_MODEL_ARM',
            'INVALID_MODEL_CHAMPION', 'INVALID_MODEL_SALES_TARGET', 'INVALID_MODEL_SAMPLE',
            'INVALID_MODEL_DAYS', 'MODEL_ARM_CREDENTIAL_MISSING', 'MODEL_ARM_LINEAGE_LIMIT',
        ]
