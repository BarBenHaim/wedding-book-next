...
export async function PATCH(req) {
    ...
    try {
        ...
        const ALLOWED = ['eventType', 'locale', 'themeColor', 'celebrantName', 'celebrantNameHe', 'age', 'customTitle', 'customSubtitle', 'customDescription', 'brideName', 'brideNameHe', 'groomName', 'groomNameHe']
        const clean = {}
