...
export async function GET(req) {
    try {
        ...
        try {
            ...
            // errorCorrectionLevel 'H' (שחזור 30%) במקום 'M' (15%) נותן
            // פטרן עם יותר מודולים — ברקוד צפוף יותר עם נקודות קטנות
            // יותר. בנוסף לעיצוב המהודר, זה גם עמיד יותר לטשטוש,
            // קמטים, וצילום בזווית — שכיח כשאורח סורק שלט באולם
            // מתחת לתאורה לא אידיאלית.
