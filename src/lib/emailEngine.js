...
צוות Wedding Tales`,
    ...
    {
        name: 'האזור האישי — כניסה עם הנייד',
        subject: 'האזור האישי שלכם לניהול ספר הברכות 💛',
        body: `שלום {{coupleName}},

מהיום יש לכם אזור אישי לניהול ספר הברכות — הכל במקום אחד:

<b>מה מחכה לכם שם?</b>
• כל הברכות והתמונות שנאספו — מתעדכן בזמן אמת
• שיתוף הקישור עם האורחים בקליק
• בחירת עיצוב לספר ועיצוב הכריכה
• הקישורים וקודי ה-QR שלכם — תמיד זמינים

<b>איך נכנסים?</b>
לוחצים על הקישור ומזינים את מספר הנייד שלכם — זה הכל, בלי סיסמאות:
https://app.weddingtales.co.il/portal

כל שאלה — פשוט השיבו למייל הזה.
שיהיה המון מזל טוב!!! 💛
צוות Wedding Tales`,
    },
    {
