...
export const JOURNEY = {
    new: {
        ...
        do: [
            ...
            'משפט אחד על מה מקבלים בסוף, ותשובה מלאה על מה ששאל. זה הערך. לא קישורים.',
    ...
    engaged: {
        ...
        do: [
            ...
            'משפט אחד שמסביר מה מקבלים, ואם המחירים עוד לא נאמרו, שני המחירים. זה כל מה שצריך כדי להחליט.',
        ...
        avoid: ['לפרט רשימת תכונות', 'להציע דמו או דוגמה שלא ביקשו', 'לחזור על מחירים שכבר נאמרו', 'יותר משני משפטים'],
    },
    demo_sent: {
        title: 'ראה את הדמו',
